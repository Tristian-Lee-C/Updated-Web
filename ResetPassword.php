<?php
	...
	if($_SESSION['validatorHolder'] === false || empty($_SESSION['validatorHolder'])){
...
<html>
	<head>
		...
		<link rel="stylesheet" href="resetpassword_template.css">
		...
		<div id="wrapper">
			...
			<div class='WebGut'>
				<div class='resetPasswordSection'>
					<form id='resetPasswordSect' action="resetpassworddb.php" method="post" class='resetPassword'>
						<fieldset>
 							<legend> Password Reset:</legend><br>
								...
								<label class='PasswordSlot'>Re-enter New Password:
									...
									<input type='hidden' name='userNameHolder' value='<?php echo $_SESSION['UserHolder'];?>'>
									<input type='hidden' name='userPWOldHolder' value='<?php echo $_SESSION['OldPWHolder'];?>'>

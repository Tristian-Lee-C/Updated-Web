...
<html>
	<head>
		...
		<link rel="stylesheet" href="account_template.css">
			...
			<hr></hr><br>
				...
				<div class='Welcome-Zone'>
					<div class='Welcome-Message'>
						<a class='Intro-Message'>Welcome to the CIS-HOT Volunteer Profile Portal</a></br></br>
						<a class='Body-Message'>If there is any question or problems, please contact our Volunteer Program Coordinator.</a>
					</div>
				</div>
			</main>
		</div>

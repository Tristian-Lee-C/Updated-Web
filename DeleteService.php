...
<html>
	<head>
		...
		<link rel="stylesheet" href="deleteservice_template.css">
	...
	<body>
		...
		<div id="wrapper">
			...
			<main>
				<div class="dashboard">
				<hr></hr>
				<br><a class="deleteServiceText">Delete Service</a><br><br>
				<hr></hr>
					...
					<form action="DeleteServiceSelect.php" method="post" class='deleteserviceform'>
					<table class ='service_list'>
						<thead>
							...
							<tbody>
								...
								<td>
								<form action='DeleteServiceSelect.php' class ="deleteServiceDeleteButton" method='post'>
									<input type='hidden' name='serviceDelete_service_id' value="<?php echo $volunteersService['serviceID'];?>">
									<input type='hidden' name='serviceDelete_volunteer_id' value="<?php echo $volunteerID;?>">
									<input type='hidden' name='serviceDelete_first_name' value="<?php echo $first_name;?>">
									<input type='hidden' name='serviceDelete_last_name' value="<?php echo $last_name;?>">	
									<input type='hidden' name='serviceDelete_school' value="<?php echo $schoolGet['school_name'];?>">	
									<input type='hidden' name='serviceDelete_student_names' value="<?php echo $volunteersService['student_names'];?>">	
									<input type='hidden' name='serviceDelete_minutes' value="<?php echo $volunteersService['service_minutes'];?>">	
									<input type='hidden' name='serviceDelete_code' value="<?php echo $CodeGet['service_code'];?>">	
									<input type='hidden' name='serviceDelete_tier' value="<?php echo $TierGet['tier_level'];?>">	
									<input type='hidden' name='serviceDelete_comment' value="<?php echo $volunteersService['service_comment'];?>">	
									<input type='hidden' name='serviceDelete_date' value="<?php echo $volunteersService['service_date'];?>">	

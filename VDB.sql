...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2024 at 04:24 PM
...
--
CREATE DATABASE IF NOT EXISTS `volunteer_database` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `volunteer_database`;
...
DROP TABLE IF EXISTS `deleted_schools`;
...
DROP TABLE IF EXISTS `deleted_staff`;
...
DROP TABLE IF EXISTS `delete_reason_table`;
...
DROP TABLE IF EXISTS `delete_staff_reason`;
...
DROP TABLE IF EXISTS `exit_list`;
...
DROP TABLE IF EXISTS `school_queue`;
...
DROP TABLE IF EXISTS `school_status_mode`;
...
DROP TABLE IF EXISTS `school_status_queue`;
...
INSERT INTO `service_code` (`service_codeID`, `service_code`) VALUES
(1, '1001TT');
...
(28, 203, '2024-04-02', 60, 'Test', '', 2, 1, 2, '2024-04-04 15:21:11', ''),
...
DROP TABLE IF EXISTS `tier_level_type`;
CREATE TABLE `tier_level_type` (
  `tierID` int(11) NOT NULL,
  `tier_level` varchar(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tier_level_type` (`tierID`, `tier_level`) VALUES
(1, 'Tier 3'),
(2, 'Tier 2'),
(3, 'Tier 1');
...
DROP TABLE IF EXISTS `volunteer_type_history`;
...
DROP TABLE IF EXISTS `volunteer_year`;
...
DROP TABLE IF EXISTS `volunteer_year_queue`;
...
--
ALTER TABLE `deleted_schools`
  MODIFY `deleted_school_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `service_code`
  MODIFY `service_codeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
